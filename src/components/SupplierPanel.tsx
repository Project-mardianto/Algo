...
export default function SupplierPanel() {
  ...
  const handleStartPreparation = (orderId: string) => {
    setOrders(
      orders.map((o) =>
        o.id === orderId
          ? { ...o, preparationStatus: "preparing" as const }
          : o,
      ),
    );
  };
      ...
      orders.map((o) =>
        o.id === orderId
          ? {
              ...
              preparationStatus: "picked-up" as const,
              status: "driver-assigned" as const,
            }
          : o,
      ),
    );
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <Card className="border-blue-100">
            <CardContent className="p-4 text-center">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {
                  orders.filter((o) => o.preparationStatus === "preparing")
                    .length
                }
              </p>
          ...
          <Card className="border-purple-100">
            <CardContent className="p-4 text-center">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {
                  orders.filter((o) => o.preparationStatus === "picked-up")
                    .length
                }
              </p>
                  ...
                  <div className="space-y-2">
                    {order.preparationStatus === "pending" && (
                      <Button
                        ...
                        className="w-full hover:bg-blue-700 bg-[#f59e0b]"
                      >
                    ...
                    {order.preparationStatus === "picked-up" &&
